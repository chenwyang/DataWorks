        ...
        <ItemTemplate>
          ...
          <table class="table table-bordered">
             ...
             <tr>
                ...
                <td id="content"; style="text-align:left">
                     <asp:Image ID="Image1" runat="server" Height="220px" ImageUrl='<%# Eval("Photo", "~/img/{0}") %>'/>
                </td>
			</tr>
			<tr>
				<td id="title"; style="text-align:right">  
			...
			<tr>
              ...
              <tr>
                 <td style="text-align:right;">
                  ...
                  <td style="text-align:left;">
                        <asp:Button ID="Button2" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnclientClick="return confirm('Are you sure you want to delete this material?')"/>
                  </td>
            </tr>
